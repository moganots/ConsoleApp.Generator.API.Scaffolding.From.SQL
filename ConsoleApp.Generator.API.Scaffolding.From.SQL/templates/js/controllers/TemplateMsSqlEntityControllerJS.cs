...
{
    public class TemplateMsSqlEntityControllerJS
    {
        ...
        public TemplateMsSqlEntityControllerJS() { }
        public TemplateMsSqlEntityControllerJS(string author, string dateCreated, string schemaName, string entityName, string controllerDirectory)
        {
            Author = author;
        ...
        public void Generate()
        {
            ...
            sb.AppendLine($"| Description   : MS SQL Entity (Model) Controller for the [{SchemaName}].[{EntityName}] Table");
            sb.AppendLine("|--------------------------------------------------------------------------------------------------------------------------------------------");
            sb.AppendLine(" */");
            sb.AppendLine("");
            sb.AppendLine("/**");
            sb.AppendLine($" * Creates an instance of the [{SchemaName}].[{EntityName}] MS SQL Entity (Model) Controller");
            ...
            sb.AppendLine($" * @returns MsSql{EntityName!.ProperCase()}Controller");
            sb.AppendLine(" */");
            ...
            sb.AppendLine($"      `MsSql{EntityName!.ProperCase()}Controller - [logger] instance has not been provided or set`");
            sb.AppendLine("    );");
            sb.AppendLine("  }");
            sb.AppendLine("  if (notSet(dbContext)) {");
            sb.AppendLine("    throw new Error(");
            sb.AppendLine($"      `MsSql{EntityName!.ProperCase()}Controller - [dbContext] instance has not been provided or set`");
            sb.AppendLine("    );");
            sb.AppendLine("  }");
            sb.AppendLine("  const dto =");
            sb.AppendLine($"    require(`./../../models/entities/mssql/{EntityName!.GetEntityFileName()}`)();");
            //sb.AppendLine("  const dbContext = require(`./../../middleware/database/context/mssql/db.context`)(");
